...
public class FractalMain {
    ...
    public FractalMain() {
        ...
        fractalHilos2 = new FractalHilos();
    ...
    private void init() {
        ...
        glfwSetKeyCallback(window, (window, key, scancode, action, mods) -> {
            ...
            if (key == GLFW_KEY_3 && action == GLFW_RELEASE) {
                System.out.println("Modo C++ SIMD mode Hilos");
                mode = 3;
            }
    ...
    private void paint() {
        ...
        if (mode == 3) {
        fractalHilos2.julia_paralela(FractalParams.xMin, FractalParams.yMin, FractalParams.xMax, FractalParams.yMax,
                    FractalParams.WIDTH, FractalParams.HEIGHT);
            pixelBuffer.put(fractalHilos2.pixel_buffer);
            //fractalSimd.JuliaSimd();
            //pixelBuffer.put(fractalSimd.pixel_buffer.asIntBuffer());
        }
